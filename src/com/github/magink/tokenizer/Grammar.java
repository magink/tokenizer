...
public class Grammar {
  ...
  protected TokenImp findMatch(String toMatch) {
    setMatcher(toMatch);
  ...
  private TokenImp foundMatch() {
    TokenImp longest = null;
    TokenImp current = null;
    if (matcher.find()) {
  ...
  private boolean isCurrentLonger(TokenImp longest ,TokenImp current) {
